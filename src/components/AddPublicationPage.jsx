...
import { uploadImageToCloudinary } from '../services/publicationService'; // Pastikan ini diimpor
...
export default function AddPublicationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (coverFile) {
      try {
        coverUrl = await uploadImageToCloudinary(coverFile); // Upload gambar ke Cloudinary
      } catch (err) {
    ...
    try {
      await addPublication(newPublication); // Panggil addPublication dari context
